export default function Card({children}){
    return <div style={styles.card}>
      <h1 style={styles.name}>{children.name}</h1>
      <div style={styles.description}>{children.description}</div>
       <h3 style={styles.interestsHeader}>Interests</h3>
        <ul style={styles.interestsList}>
            {children.interests.map((interest) => (
                <li style={styles.interestItem}>
                    {interest}
                </li>
            ))}
            </ul>
        ...
        <button 
            style={styles.link} 
            onClick={() => window.open(children.linkedin, '_blank')}
        >
            LinkedIn
        </button>
        ...
        <button
            style={styles.link} 
            onClick={() => window.open(children.twitter, '_blank')}
        >
            Twitter
        </button>
      </div>
